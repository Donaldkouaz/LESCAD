...
class Sss
{
   ...
   /**
     * 
     * @Vich\UploadableField(mapping="sss_image", fileNameProperty="nomImage", size="tailleImage")
     * 
     * @var File
     */
    private $fichierImage;
     ...
     /**
     * 
     * @Vich\UploadableField(mapping="sss_banniere", fileNameProperty="nomBanniere", size="tailleBanniere")
     * 
     * @var File
     */
